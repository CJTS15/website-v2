...
const ProjectItems = ({title, backgroundImg, projectStack, projectUrl}) => {
  return (
    ...
    shadow-md shadow-gray-300 dark:shadow-shadow-dark rounded-md group h
    over:bg-gradient-to-r from-blue-500 to-cyan-500">
        <Image className="rounded-md group-hover:opacity-10 ease-in duration-200" src={backgroundImg} width='2000' height='1333' alt=""/>
            <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <a href={projectUrl}>
                    <button type="button" className="btn-tertiary ">Visit Site</button>
                </a>
            </div>
    </div>
  )
