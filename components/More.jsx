        ...
        <div ref={ref} className="w-full lg:h-screen flex items-center lg:py-28 py-16 px-8 dark:bg-bg-darker transition-colors">
            <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 ">
                <div className="col-span-2">
                    ...
                    <motion.h1 animate={fadeRight} className="py-4 dark:text-h-dark-light">Game. Code. Sleep.</motion.h1>
                    <motion.p animate={fadeRight} className="py-2 dark:text-p-dark-light">Gaming serves as my personal retreat from reality.
                    ...
                    <motion.p animate={fadeRight} className="py-2 dark:text-p-dark-light">In addition to my gaming pursuits, I also engage in coding and research activities.
